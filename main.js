...
function addRow() {
  ...
  function addthis(){
    const x = localStorage.getItem(div);
    document.getElementById('postspace').appendChild(x);
  }
  
  function removeRow(input) {
    document.getElementById('postspace').removeChild(input.parentNode);
  }
  */